...
class InspectionMeasurementResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            'nominal_value'   => $this->nominal_value !== null ? (string) $this->nominal_value : null,
            'tolerance_min'   => $this->tolerance_min !== null ? (string) $this->tolerance_min : null,
            'tolerance_max'   => $this->tolerance_max !== null ? (string) $this->tolerance_max : null,
            'measured_value'  => $this->measured_value !== null ? (string) $this->measured_value : null,
