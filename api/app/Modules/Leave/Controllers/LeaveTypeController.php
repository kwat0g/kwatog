...
class LeaveTypeController
{
    public function __construct(
        ...
        private readonly YearEndLeaveProcessingService $yearEnd,
    ) {}
    ...
    public function processYearEnd(ProcessYearEndLeaveRequest $request): JsonResponse
    {
        ...
        $outbox = $this->yearEnd->request($request->user(), $year);

        return response()->json([
            'message' => 'Year-end leave processing has been durably queued.',
