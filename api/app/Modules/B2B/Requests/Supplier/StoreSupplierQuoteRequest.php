...
class StoreSupplierQuoteRequest extends FormRequest
{
    ...
    {
        return [
            'vat_inclusive' => ['boolean'], 'freight_amount' => ['nullable', 'decimal:0,2', 'min:0'],
            'other_charges' => ['nullable', 'decimal:0,2', 'min:0'], 'quote_valid_until' => ['nullable', 'date'],
            'payment_terms' => ['nullable', 'string', 'max:150'], 'notes' => ['nullable', 'string', 'max:5000'],
            'quotation_path' => ['nullable', 'string', 'max:500'], 'quotation_original_filename' => ['nullable', 'string', 'max:255'],
            'items' => ['required', 'array', 'min:1'],
            'items.*.request_for_quote_item_id' => ['required', 'integer'],
