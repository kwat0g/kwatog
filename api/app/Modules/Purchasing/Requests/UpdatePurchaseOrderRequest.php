...
class UpdatePurchaseOrderRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            // Bounds and 3dp quantity precision match StorePurchaseOrderRequest;
            // update() rewrites the same order line and money columns.
            'items.*.quantity'       => ['required_with:items', 'decimal:0,3', 'min:0.001', 'max:999999.999'],
