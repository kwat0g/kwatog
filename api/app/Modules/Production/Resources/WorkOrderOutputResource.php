    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'production_receipt_handoff' => [
                ...
                'movement_id' => $this->when($this->production_receipt_movement_id !== null, fn () => $this->relationLoaded('productionReceiptMovement') && $this->productionReceiptMovement
            ...
            'defects' => $this->whenLoaded('defects', fn () => $this->defects->map(fn ($d) => [
                'id' => $d->hash_id,
                'count' => (int) $d->count,
