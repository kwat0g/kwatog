    ...
    public static function defaults(): array
    {
        return [
            ...
            ['title' => 'Chain 2 · Procure to Pay', 'hint' => 'Requests, purchase orders, and goods receipts', 'types' => [
                ...
                ['key' => 'purchasing.rfq_closed', 'label' => 'RFQ ready to award', 'description' => 'A supplier RFQ closed; its quotations are ready to compare and award.'],
                ['key' => 'purchasing.rfq_awarded', 'label' => 'RFQ awarded', 'description' => 'An RFQ award generated draft purchase orders.'],
                ['key' => 'purchasing.rfq_cancelled', 'label' => 'RFQ cancelled', 'description' => 'A supplier RFQ was cancelled or closed without quotations.'],
