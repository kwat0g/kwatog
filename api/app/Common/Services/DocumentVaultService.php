...
class DocumentVaultService
{
    ...
    public function readBytes(Document $doc): string
    {
        ...
        $size = (int) ($disk->size($doc->file_path) ?: 0);
        if ($size > self::MAX_BYTES) {
            throw new RuntimeException('Vault blob exceeds the configured delivery limit.');
        }
    ...
    private function entityRef(Model $entity): string
    {
        ...
        foreach (['employee_no', 'invoice_number', 'po_number', 'wo_number',
            ...
            'pr_number', 'je_number', 'shipment_number', 'complaint_number',
            'reference_no', 'code'] as $col) {
