...
class SettingsSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $rows = [
            ...
            // ── Quality policies ─────────────────────────────
            ['key' => 'quality.incoming_failure.mrb_review', 'value' => true, 'group' => 'quality', 'label' => 'Incoming QC Failure MRB Review', 'description' => 'When true, failed incoming inspections await material review board disposition before GRN acceptance/rejection. When false, use legacy auto-reject behavior.'],
            ...
            ['key' => 'accounting.accounts.loan_disbursement_receivable_code', 'value' => '1110', 'group' => 'accounting', 'label' => 'Employee Loan Disbursement Receivable Account Code', 'description' => 'Asset account debited when an approved employee loan is disbursed.'],
            ['key' => 'accounting.accounts.loan_disbursement_cash_code', 'value' => '1020', 'group' => 'accounting', 'label' => 'Employee Loan Disbursement Cash Account Code', 'description' => 'Cash account credited when an approved employee loan is disbursed.'],
            ['key' => 'accounting.accounts.loan_disbursement_interest_income_code', 'value' => '4020', 'group' => 'accounting', 'label' => 'Employee Loan Interest Income Account Code', 'description' => 'Revenue account credited for interest included in an employee loan balance.'],
            ['key' => 'accounting.accounts.loan_repayment_cash_code', 'value' => '1020', 'group' => 'accounting', 'label' => 'Employee Loan Repayment Cash Account Code', 'description' => 'Cash account debited for a manual employee loan repayment.'],
            ['key' => 'accounting.accounts.loan_repayment_receivable_code', 'value' => '1110', 'group' => 'accounting', 'label' => 'Employee Loan Repayment Receivable Account Code', 'description' => 'Employee loan receivable account credited for a manual repayment.'],
            ['key' => 'accounting.accounts.loan_write_off_expense_code', 'value' => '6130', 'group' => 'accounting', 'label' => 'Employee Loan Write-off Expense Account Code', 'description' => 'Expense account debited when Finance approves an employee loan write-off.'],
            ['key' => 'accounting.accounts.loan_write_off_receivable_code', 'value' => '1110', 'group' => 'accounting', 'label' => 'Employee Loan Write-off Receivable Account Code', 'description' => 'Employee loan receivable account credited when Finance approves a write-off.'],
            ...
            ['key' => 'accounting.accounts.discount_code', 'value' => '4040', 'group' => 'accounting', 'label' => 'Sales Discount Account Code', 'description' => 'Chart-of-accounts mapping used for contra-revenue discounts.'],
            ...
            ['key' => 'accounting.accounts.landed_cost_clearing_code', 'value' => '2120', 'group' => 'accounting', 'label' => 'Landed Cost Clearing Account Code', 'description' => 'Liability account credited when imported landed costs are capitalized into inventory.'],
            ['key' => 'accounting.accounts.purchase_price_variance_code', 'value' => '5040', 'group' => 'accounting', 'label' => 'Purchase Price Variance Account Code', 'description' => 'Expense account for variances between bill and GRN costs in stock purchases.'],
            ...
            ['key' => 'accounting.accounts.inventory_delivery_transit_code', 'value' => '1240', 'group' => 'accounting', 'label' => 'Delivery Transit Inventory Account Code', 'description' => 'Asset account holding finished goods after dispatch and before customer receipt, return, or loss recognition.'],
            ['key' => 'accounting.accounts.delivery_cogs_code', 'value' => '5010', 'group' => 'accounting', 'label' => 'Delivery Cost of Goods Sold Account Code', 'description' => 'Expense account debited for the immutable cost of goods actually accepted by a customer.'],
            ['key' => 'accounting.accounts.delivery_loss_code', 'value' => '6135', 'group' => 'accounting', 'label' => 'Delivery Loss Expense Account Code', 'description' => 'Expense account debited for shipment quantities reconciled as unaccounted after depot count.'],
            ['key' => 'accounting.accounts.purchase_return_expense_code', 'value' => '5010', 'group' => 'accounting', 'label' => 'Purchase Return Expense Account Code', 'description' => 'Expense account used to post supplier/purchase return credit notes that have no source bill line.'],
            ...
            ['key' => 'accounting.default_expense_account_code', 'value' => '5010', 'group' => 'accounting', 'label' => 'Default Expense Account Code', 'description' => 'Fallback expense account used by supplier portal invoice creation.'],
            ...
            ['key' => 'accounting.accounts.ewt_payable_code', 'value' => '2051', 'group' => 'accounting', 'label' => 'Expanded Withholding Tax Payable Account Code', 'description' => 'Liability account credited when EWT is withheld on supplier payments.'],
            ...
            ['key' => 'accounting.accounts.salary_expense_code', 'value' => '6010', 'group' => 'accounting', 'label' => 'Salary Expense Account Code', 'description' => 'Operating payroll GL account mapping.'],
            ['key' => 'accounting.accounts.overtime_expense_code', 'value' => '6015', 'group' => 'accounting', 'label' => 'Overtime Expense Account Code', 'description' => 'Operating payroll GL account mapping.'],
            ['key' => 'accounting.accounts.thirteenth_month_expense_code', 'value' => '6020', 'group' => 'accounting', 'label' => '13th Month Expense Account Code', 'description' => 'Operating payroll GL account mapping.'],
            ['key' => 'accounting.accounts.production_salary_expense_code', 'value' => '5020', 'group' => 'accounting', 'label' => 'Production Salary Expense Account Code', 'description' => 'Direct production labor GL account mapping.'],
            ['key' => 'accounting.accounts.production_overtime_expense_code', 'value' => '5020', 'group' => 'accounting', 'label' => 'Production Overtime Expense Account Code', 'description' => 'Direct production labor premium GL account mapping.'],
            ['key' => 'accounting.accounts.production_thirteenth_month_expense_code', 'value' => '5070', 'group' => 'accounting', 'label' => 'Production 13th Month Expense Account Code', 'description' => 'Direct production labor 13th-month GL account mapping.'],
            ['key' => 'accounting.payroll.direct_labor_department_codes', 'value' => ['PROD', 'PRD'], 'group' => 'accounting', 'label' => 'Direct Labor Department Codes', 'description' => 'Department codes whose payroll wages are posted to direct labor accounts.'],
