    ...
    private function employeeFor(array $account, int $index): Employee
    {
        ...
        return Employee::updateOrCreate(
            ...
            [
                ...
                'street_address'       => (100 + $index) . ' Governor Drive',
                'barangay'             => 'Langkaan I',
                ...
                'emergency_contact_phone'    => '+63918' . str_pad((string) (2000000 + $index), 7, '0', STR_PAD_LEFT),
                'sss_no'               => '34-' . str_pad((string) (2000000 + $index), 7, '0', STR_PAD_LEFT) . '-1',
                'philhealth_no'        => '12-' . str_pad((string) (200000000 + $index), 9, '0', STR_PAD_LEFT) . '-2',
                'pagibig_no'           => '1234-5678-' . str_pad((string) (2000 + $index), 4, '0', STR_PAD_LEFT),
                'tin'                  => '123-456-' . str_pad((string) (100 + $index), 3, '0', STR_PAD_LEFT) . '-000',
