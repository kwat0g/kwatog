...
/** Add the read-side SLA for confirmed deliveries without a customer invoice. */
return new class extends Migration
{
    public function up(): void
    {
        ...
        $updated = $current + [
            'delivery_confirmed_without_invoice' => [
                'label' => 'Confirmed delivery awaiting customer invoice',
                'hours' => 4,
    ...
    public function down(): void
    {
        ...
        unset($current['delivery_confirmed_without_invoice']);
