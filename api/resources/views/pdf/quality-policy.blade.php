...
<div class="page">
  ...
  <div class="section">
    ...
    <p>
      Every employee is responsible for understanding this policy and for upholding the
      quality standards of their respective work area. Quality is not the sole
      responsibility of the Quality Control department — it is woven into every step
      of our order-to-cash and procure-to-pay processes.
    </p>
  </div>
  ...
  <div class="signatures">
    ...
    <div class="sig-cell right">
      ...
      <div class="sig-name">Document Control — QMS</div>
    </div>
  </div>
