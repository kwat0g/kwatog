...
export class PurchaseRequestListPage extends BasePage {
  ...
  get heading(): Locator { return this.page.getByRole('heading', { name: /purchase requests/i, level: 1 }); }
...
export class PurchaseOrderListPage extends BasePage {
  ...
  get heading(): Locator { return this.page.getByRole('heading', { name: /purchase orders/i, level: 1 }); }
