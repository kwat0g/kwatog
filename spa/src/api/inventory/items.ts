...
export const itemsApi = {
 ...
 restore: (id: string) =>
  client.patch(`/inventory/items/${id}/restore`),
};
...
export const itemCategoriesApi = {
 list: (params?: { trashed?: 'with' | 'only' }) =>
  client.get<{ data: ItemCategory[] }>('/inventory/item-categories', { params }).then((r) => r.data.data),
 tree: (params?: { trashed?: 'with' | 'only' }) =>
  client.get<{ data: ItemCategory[] }>('/inventory/item-categories/tree', { params }).then((r) => r.data.data),
 ...
 restoreCategory: (id: string) =>
  client.patch(`/inventory/item-categories/${id}/restore`),
};
