...
export const purchaseRequestsApi = {
 ...
 client.post<PurchaseRequest>('/purchasing/purchase-requests', data).then((r) => r.data),
  ...
  setSourcingMethod: (id: string, sourcing_method: 'direct_po' | 'rfq') =>
  client.patch<PurchaseRequest>(`/purchasing/purchase-requests/${id}/sourcing-method`, { sourcing_method }).then((r) => r.data),
 delete: (id: string) => client.delete(`/purchasing/purchase-requests/${id}`),
 restore: (id: string) => client.patch(`/purchasing/purchase-requests/${id}/restore`),
 submit: (id: string) =>
...
export const prTemplatesApi = {
 ...
 restoreTemplate: (id: string) => client.patch(`/purchasing/pr-templates/${id}/restore`),
};
