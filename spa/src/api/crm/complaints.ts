...
export const complaintsApi = {
 ...
 client.get<PaginatedResponse<CustomerComplaint>>('/crm/complaints', { params, signal }).then((r) => r.data),
 show: (id: string) =>
 ...
 retryNcr: (id: string) =>
  client.post<ApiSuccess<CustomerComplaint>>(`/crm/complaints/${id}/retry-ncr`).then((r) => r.data.data),
