...
export const periodsApi = {
 ...
 client.patch<ApiSuccess<PayrollPeriod>>(`/payroll-periods/${id}/request-correction`, { reason }).then((r) => r.data.data),
 finalize: (id: string) =>
 client.patch<ApiSuccess<PayrollPeriod>>(`/payroll-periods/${id}/finalize`).then((r) => r.data.data),
 retryGl: (id: string) =>
 client.post<ApiSuccess<PayrollPeriod>>(`/payroll-periods/${id}/retry-gl`).then((r) => r.data.data),
