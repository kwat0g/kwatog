          ...
          {(t) => (
            ...
            >
              ...
              <button
                ...
                className="absolute right-3 top-1/2 -translate-y-1/2 p-1 text-muted hover:text-primary rounded-md opacity-0 group-hover:opacity-100 focus:opacity-100 focus:outline-none focus:ring-2 focus:ring-accent transition-opacity"
                aria-label="Close"
              >
                <svg
                  width="14"
