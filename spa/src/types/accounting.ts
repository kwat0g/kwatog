...
/** A translated statement line carries both the PHP source and reporting-ccy amount. */
...
export interface TranslatedGroup {
 accounts: TranslatedLine[];
 total: string;
}
export interface TranslatedBalanceSheet {
 as_of: string;
 currency: string;
 closing_rate: string;
 average_rate: string;
 assets: TranslatedGroup;
 liabilities: TranslatedGroup;
 equity: TranslatedGroup;
 cta: string;
 total_assets: string;
 total_liabilities_equity: string;
 balanced: boolean;
}
export interface TranslatedIncomeStatement {
 from: string;
 to: string;
 currency: string;
 average_rate: string;
 statement: {
 revenue: TranslatedGroup;
 cogs: TranslatedGroup;
 gross_profit: string;
 operating_expenses: TranslatedGroup;
 net_income: string;
 };
}
export interface TranslatedTrialBalance {
 ...
 debit_total: string; credit_total: string; balance: string; balance_side: string;
 }>;
 totals: { debit: string; credit: string };
}
