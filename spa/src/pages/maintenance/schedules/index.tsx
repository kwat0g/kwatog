...
const [filters, setFilters] = useUrlFilters<ScheduleListParams>({ page: 1, per_page: 25 });
 ...
 const { data, isLoading, isError, refetch } = useQuery({
  queryKey: ['maintenance', 'schedules', scope, filters],
  queryFn: () => schedulesApi.list({ ...filters, trashed: archiveToTrashed(scope) }),
...
<ConfirmDialog
  ...
  description="It will be restored and become eligible to materialise work orders again."
