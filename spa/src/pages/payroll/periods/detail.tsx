...
import { Play, CheckCircle2, Lock, Download, AlertCircle, Upload, Eye, ArchiveRestore, Trash2, Banknote, Ban, RefreshCw } from 'lucide-react';
...
export default function PayrollPeriodDetailPage() {
 ...
 // initialisation.
 enabled: Boolean(period?.id) && Boolean(bankFormat)
