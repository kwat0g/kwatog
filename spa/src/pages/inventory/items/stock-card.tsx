...
import { localIsoDate, formatDateTime } from '@/lib/formatDate';
  ...
  return (
    <div>
      <PageHeader
        ...
        backLabel="Items"
        subtitle={data ? `${data.item.code} · ${data.item.name}` : undefined}
        actions={
      ...
      {data && data.rows.length === 0 && (
        <div className="px-5 py-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mb-4">
            ...
            />
            <StatCard label="Weighted avg cost" value={fmtMoney(data.closing.weighted_avg)} />
          </div>
          <EmptyState
            icon="package"
