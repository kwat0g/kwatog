      ...
      >
          ...
          >
            ...
            {options && (
              <p className="text-xs text-muted mt-2">
                Requests must fall within the configured window (past {options.request_past_days}d ·
                future {options.request_future_days}d). Maximum {options.maximum_hours} hours per
                day.
              </p>
            )}
            <div className="mt-3">
        ...
        <FormActions>
          <Button
            type="button"
            variant="secondary"
            onClick={() => navigate('/hr/attendance/overtime')}
          >
            Cancel
          </Button>
          <Button
            ...
            variant="primary"
            disabled={
              isSubmitting || mutation.isPending || optionsLoading || optionsError || !options
            }
