          ...
          {PARTS.map((part, i) => {
            ...
            return (
              <article
                ...
                className="group relative overflow-hidden rounded-2xl border border-landing-border bg-landing-canvas p-6 transition-all duration-500 hover:-translate-y-1 hover:border-landing-accent/40"
              >
