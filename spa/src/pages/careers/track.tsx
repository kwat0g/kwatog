        ...
        {info && (
          <div className="mt-8 rounded-md border border-default p-5">
            <div className="mb-6">
              ...
              <p className="mt-1 text-sm text-muted">Applied on {formatDate(info.applied_at)}</p>
            ...
            {isRejected ? (
              <div className="rounded-md bg-surface p-4 text-center">
                <p className="font-medium text-secondary">
                  Thank you for your interest. Unfortunately, we have decided to move forward with
                  other candidates.
                </p>
              </div>
            ) : (
                    ...
                    <div key={step.value} className="flex items-start gap-3 py-2">
                      <div className="flex flex-col items-center">
                        ...
                        {idx < info.stage_steps.length - 1 && (
                          <div
                            className={`h-6 w-0.5 ${isDone ? 'bg-success-bg' : 'bg-elevated'}`}
                          />
                        )}
                      </div>
                      <span
