  ...
  return (
    <div>
              ...
              <Button
                ...
                onClick={() =>
                  void downloadAuthenticatedFile(
                    statementsApi.csvUrl('ap-aging', { as_of: asOf }),
                    { errorMessage: 'Failed to export AP aging.' },
                  )
                }
              >
                CSV
      ...
      {isError && (
        <EmptyState
          icon="alert-circle"
          title="Failed to generate AP aging"
          action={
      ...
      {data && data.by_vendor.length === 0 && (
        <EmptyState icon="inbox" title="No outstanding payables" />
      )}
      {data && data.by_vendor.length > 0 && (
