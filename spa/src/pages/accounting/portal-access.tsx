...
import { portalAccessApi, type PortalAccessListParams } from '@/api/b2b/portal-access';
...
const statusLabels: Record<SupplierPortalUser['status'], string> = {
 active: 'Active',
 inactive: 'Inactive',
 locked: 'Locked',
...
type ConfirmAction = { kind: 'deactivate' | 'revoke'; user: SupplierPortalUser } | null;
...
export default function SupplierPortalAccessPage() {
 ...
 const list = useQuery({
  queryKey: ['b2b', 'portal-access', filters],
 ...
 const filterConfig: FilterConfig[] = [
  { key: 'status', label: 'Status', type: 'select', options: [
   { value: '', label: 'All' }, { value: 'active', label: 'Active' }, { value: 'pending', label: 'Pending' }, { value: 'locked', label: 'Locked' }, { value: 'inactive', label: 'Inactive' },
  ] },
 ];
 ...
 return <div>
  <PageHeader
   ...
   subtitle={list.data ? `${list.data.meta.total} external accounts` : 'Manage supplier login lifecycle'}
