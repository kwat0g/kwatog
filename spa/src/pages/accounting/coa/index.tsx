...
export default function ChartOfAccountsPage() {
 ...
 <div className="grid grid-cols-1 md:grid-cols-12 h-row px-2.5 items-center bg-canvas text-2xs uppercase tracking-wider text-muted font-medium border-b border-default">
...
function TreeRow({
 ...
 return (
 <>
 <div className={cn('group grid grid-cols-1 md:grid-cols-12 h-8 px-2.5 items-center border-b border-subtle hover:bg-subtle text-sm', !node.is_active && 'opacity-60')}>
