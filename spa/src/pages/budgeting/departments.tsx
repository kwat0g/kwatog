  ...
  const {
    ...
    queryFn: async () => {
      ...
      return res.data.filter(
        (b) =>
          b.department?.name === departmentName ||
          (!b.department && departmentName === 'Company-wide'),
      );
    },
    ...
    <div className="p-5 space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <StatCard
          ...
          value={formatCompactCurrency(totalAllocated, 1_000_000, 'M')}
        />
        ...
        <Panel
          ...
          meta={
            <div className="flex items-center gap-3">
              <Chip variant={chipVariantForStatus(budget.status)}>
