...
export default function DepartmentsPage() {
 ...
 const { data: rows = [], isLoading, isError, refetch } = useQuery({
  queryKey: ['hr', 'departments', 'tree', scope],
  queryFn: () => departmentsApi.tree({ trashed: archiveToTrashed(scope) }),
 ...
 const deleteMutation = useMutation({
  ...
  toast.error(e.response?.data?.message ?? 'Failed to archive department.');
  },
 });
 ...
 const restoreMutation = useMutation({
  ...
  onError: (e: AxiosError<{ message?: string }>) => {
  toast.error(e.response?.data?.message ?? 'Failed to restore department.');
  },
 });
