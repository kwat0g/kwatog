...
export default function PostingEditPage() {
 ...
 <Input label="Salary Min" {...register('salary_range_min')} type="number" step="0.01" prefix="₱" error={errors.salary_range_min?.message} />
 <Input label="Salary Max" {...register('salary_range_max')} type="number" step="0.01" prefix="₱" error={errors.salary_range_max?.message} />
