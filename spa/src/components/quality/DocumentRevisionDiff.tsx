...
export function DocumentRevisionDiff({ revisions, documentCode, title }: DocumentRevisionDiffProps) {
 ...
 className="bg-surface border border-default rounded px-2 py-1 text-xs font-mono text-primary"
 >
 {revisions.map((r, idx) => (
 ...
 <div className="bg-canvas p-2.5 rounded border border-default/50 text-2xs font-mono text-secondary space-y-1">
 ...
 <div className="flex justify-between">
 <span className="text-muted text-2xs">Effective Date</span>
 <span className="font-mono text-primary font-medium">{revB.effective_date ?? 'Immediate'}</span>
 </div>
 <div className="flex justify-between">
 <span className="text-muted text-2xs">Author / Originator</span>
