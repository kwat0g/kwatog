  ...
  return (
    <div className="min-h-screen w-full bg-canvas text-primary flex flex-col animate-fade-in font-sans">
      ...
      <div className="max-w-5xl mx-auto w-full px-6 py-6">
        <div className="h-80 md:h-96 rounded-xl border border-default bg-surface p-6 flex flex-col justify-between overflow-hidden relative shadow-sm">
      ...
      <div className="max-w-6xl mx-auto w-full px-6 py-12 border-t border-subtle">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          {[1, 2, 3, 4].map((i) => (
            <div key={i} className="p-4 rounded-lg bg-surface border border-default space-y-2">
