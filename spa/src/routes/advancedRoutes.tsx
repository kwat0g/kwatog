  ...
  <>
    ...
    <Route element={<ModuleGuard module="forecasting" />}>
      <Route
        ...
        element={
          <PermissionGuard permission="forecasting.view">
            <DemandForecastingPage />
          </PermissionGuard>
        }
      />
      <Route
        path="/forecasting/stock-out"
        element={
          <PermissionGuard permission="forecasting.view">
            <StockOutProjectionPage />
          </PermissionGuard>
        }
      />
      <Route
    ...
    <Route element={<ModuleGuard module="budgeting" />}>
      ...
      />
      <Route
        path="/budgeting/departments/:id"
        element={
          <PermissionGuard permission="budgeting.view">
            <DepartmentBudgetDetailPage />
          </PermissionGuard>
        }
      />
      <Route
    ...
    <Route element={<ModuleGuard module="return_management" />}>
      ...
      />
      <Route
        path="/return-management/:id/edit"
        element={
          <PermissionGuard permission="return_management.manage">
            <CreateReturnRequestPage />
          </PermissionGuard>
      ...
      />
      <Route
        path="/return-management/:id"
        element={
          <PermissionGuard permission="return_management.view">
            <ReturnManagementDetailPage />
          </PermissionGuard>
        }
      />
    </Route>
